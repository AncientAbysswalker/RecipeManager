    ...
    <div class="recipe__page__column">
      <div id="section-header">
        ...
        <v-carousel class="caru" :show-arrows="false">
          <v-carousel-item
            v-if="this.fields.images && this.fields.images.length === 0"
            :src="
      ...
      <div id="section-ingredients">
        <h2>Ingredients</h2>
        <div v-for="(ingredient_section, index) in this.fields.ingredients"
            :key="index" class="instruction__card__container">
          <p class="instruction__card__header">Optional Header?</p>
          <div class="paper">
            <p
              class="subsection__numbered__item"
              v-for="(ingredient, index) in ingredient_section.ingredients"
              v-bind:key="index"
            >
